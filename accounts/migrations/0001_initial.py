# Generated by Django 5.0.2 on 2025-04-07 19:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('INVESTOR', 'Investor'), ('FARMER', 'Farmer'), ('AGENT', 'Agent')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_type', models.CharField(choices=[('INVESTOR', 'Investor'), ('FARMER', 'Farmer'), ('AGENT', 'Agent')], max_length=10)),
